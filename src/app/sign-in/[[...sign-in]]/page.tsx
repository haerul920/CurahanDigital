...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        // Use JSON.stringify for cleaner error logging needed for debug,
        // but for user display we might want something friendlier
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-cyan-500/10 blur-[100px] rounded-full pointer-events-none -z-10 opacity-30 mix-blend-screen" />
      ...
      <div className="w-full max-w-md p-8 glass-card rounded-2xl border border-emerald-500/10 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">
            Sign in to continue to CurahanDigital
          </p>
        </div>
